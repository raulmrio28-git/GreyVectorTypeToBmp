...
typedef GB_INT32(*GB_ENCODER_GETCOUNT)(GB_Creator creator);
typedef GB_INT32(*GB_ENCODER_SETPARAM)(GB_Creator creator, void *pParam);
typedef GB_INT32(*GB_ENCODER_DELETE)(GB_Creator creator, GB_UINT32 nCode);
typedef GB_INT32(*GB_ENCODER_ENCODE)(GB_Creator creator, GB_UINT32 nCode, GB_Data pData);
typedef GB_INT32(*GB_ENCODER_FLUSH)(GB_Creator creator);
typedef void(*GB_ENCODER_DONE)(GB_Creator creator);
